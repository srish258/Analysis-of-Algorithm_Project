    ...
    public static void main(String[] args) {
        ...
        while (no_of_files < 14){
            ...
            if(input_file.exists()){
                //#####################################################################################################
                File output = new File(System.getProperty("user.dir"), "outputs/output" + Integer.toString(no_of_files) +".txt");
                if(output.exists()){
                    output.delete();
                }
                try{
...
//                String Y_str2 = Y1_str2 + " " + Y2_str2;
                ...
                sendToOutput(result.get("Cost").toString(), "", no_of_files);
    ...
    public static void sendToOutput(String line1, String line2, int file_number) {
        try{
            FileWriter output = new FileWriter(System.getProperty("user.dir") + "/outputs/output" + Integer.toString(file_number) +".txt", true);
